...
def setup_site(apps, schema_editor):
    ...
    # NEW: We add a check to ensure the domain_name is not empty.
    # This prevents the migration from crashing if the environment variable is missing.
    if domain_name:
        ...
        # If the variable is not set, we print a warning and do nothing.
        print("\nWARNING: SITE_DOMAIN environment variable not set. Skipping site setup.")
